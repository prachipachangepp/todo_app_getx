      ...
      body: Form(
        ...
        child: ListView(
          children: [
            ...
            Obx( () {
                  var totalTodods = homeCtrl.doingTodos.length + homeCtrl.doneTodos.length;
                  return Padding(
                    ...
                    Text('$totalTodods Tasks',
                      ...
                      Expanded(child: StepProgressIndicator(
                          totalSteps: totalTodods == 0 ? 1 : totalTodods,
                    ...
                    onPressed: (){
                      if(homeCtrl.formKey.currentState!.validate()){
                        ...
                        if(success){
                          ...
                          EasyLoading.showError('Todo iem already exist');
                        }
                        homeCtrl.editCtrl.clear();
                      }
                    },
